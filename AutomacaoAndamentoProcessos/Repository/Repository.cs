    ...
    internal class Repository
    {
        ...
        public List<Solicitacao> RetornaSolicitacoes()
        {
            ...
            for (int NOrg = 3; NOrg > 0; NOrg--)
            {
                ...
                //SqlCommand cmd = new($"select * From Fila_Andamento  where numero_Processo in ('0004236-40.2010.8.26.0197','0004684-13.2010.8.26.0197','0003803-02.2011.8.26.0197','0509851-27.2006.8.26.0606','1093176-10.2023.8.26.0002'  )", conexao); 
